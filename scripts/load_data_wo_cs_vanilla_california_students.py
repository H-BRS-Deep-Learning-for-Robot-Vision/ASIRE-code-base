...
plot_and_save_fig = True # set False if you dont want to plot the figures and save them
...
filepaths_imagedata = sorted(glob.glob('/media/ravi/ubuntu_disk/ravi/DLRV/dataset/*/*/*.jpg')) # gather all filepaths to the images to a list and sort them # modified for one year data
